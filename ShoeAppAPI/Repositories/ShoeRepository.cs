...
namespace ShoeShopAPI.Repositories
{
    public class ShoeRepository : IShoeRepository
    {
        ...
        public async Task<IEnumerable<Shoe>> GetAllAsync() => await _context.Shoes.ToListAsync();
        public async Task<Shoe?> GetByIdAsync(int id) => await _context.Shoes.FindAsync(id);
